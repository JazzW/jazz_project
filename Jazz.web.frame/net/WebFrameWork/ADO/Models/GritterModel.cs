...
namespace WebFrameWork.ADO.Models
{
    ...
    /// 旧提示数据模型（已弃用）
    /// </summary>
    public class GritterModel
    {
        /// <summary>
        /// 状态：warning,error,success,info
        /// </summary>
    ...
    /// <summary>
    /// ResponseResult构造函数参数
    /// </summary>
    public enum RSResultType { 操作成功, 没有权限 };
    ...
    public class ResponseResult
    {
        ...
        public ResponseResult(RSResultType obj)
        {
            switch (obj)
            {
                case RSResultType.操作成功:
                    this._Msg = "操作成功";
                    this.State = 1;
                    break;
                case RSResultType.没有权限:
                    this._Msg = "没有相关权限";
                    this.State = 2;
                    break;
            }
