...
namespace WebFrameWork.Helper
{
    ...
    public class LamdaHelper
    {
        ...
        public static Expression<Func<T, bool>> createOr<T>(Expression<Func<T, bool>> expr1,
        ...
        public static Expression<Func<T, bool>> createAnd<T>(Expression<Func<T, bool>> expr1,
                                                             Expression<Func<T, bool>> expr2)
        {
            if (expr1 == null)
                return expr2;
